...
derive('*','so_onevar','get_oneVar','so')
derive('*','thetao_onevar','get_oneVar','thetao')
...
# -- Biogeochemistry
derive('*','NO3_onevar','get_oneVar','NO3')
...
derive('*','PO4_onevar','get_oneVar','PO4')
...
derive('*','O2_onevar','get_oneVar','O2')
...
derive('*','Si_onevar','get_oneVar','Si')
