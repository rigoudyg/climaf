...
__all__=[ "example", "cami", "cmip5", "ocmip5" , "obs4mips" , "em" , "erai", "erai_land", "gpcc", "gpcp", "ceres", "cruts3", "file", "ref_ts", "ref_climatos", "igcm_out", "igcm_out_old", "igcm_out_altern1", "igcm_out_altern2"]
