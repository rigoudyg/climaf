...
if root:
  ...
  # ---------------------------------------------------------------------------- >
  cproject('IGCM_CMIP6', 'root', 'login', 'IPSL_MODEL', 'status', 'experiment', 'realm', 'frequency', 'table', 'model', 'realization', 'grid', ensemble=['model','simulation', 'realization'],separator='%')
