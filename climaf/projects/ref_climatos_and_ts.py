...
This module declares the climatological annual cycles and the 'time series' (one variable 
evolving with time) of a set of reference products as managed by J. Servonnat at IPSL.
...
Default values of the attributes for climatologies :
...
Default values of the attributes for time_series:
