...
def possible_values(project, tag, root, key, value_pattern):
    ...
    params = {
        "CMIP6" : {
            ...
            "mip_institute_experiment2model" : { "glob_pattern": "/*/*/*/*", "split_index": -2,
                                                 "key_index": [-4,-3,-1] },
            "mip_model2experiment" : { "glob_pattern": "/*/*/*/*", "split_index": -1, "key_index": [-4,-2]},
            "mip_model_experiment2realization" : { "glob_pattern": "/*/*/*/*/*", "split_index": -1,
                                                   "key_index": [-5,-3,-2]},
            "model_table_variable2grid" : { "glob_pattern": "/CMIP/*/*/historical/r1i*/*/*/*",
                                            "split_index": -1, "key_index": [-6,-3,-2]},
