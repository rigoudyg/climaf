...
fig1=plot(sic,title="Sic 198310 2",proj="NH70",levels="0.1 10 30 60 80 90 95 97 98 99", contours=1, mask=ocean)
cshow(fig1)

# Create a dictionnary in order to simplify the way to provide constant plot args :
pa=dict(proj="NH70",levels="0.1 10 30 60 80 90 95 97 98 99", contours=1,mask=ocean)
