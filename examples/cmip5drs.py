...
This example will work as is on CNRM's Lustre and on Ciclad, and can be easily tuned to other local CMIP5 datasets

NOTE : Bothe the CMIP5 project definition and the CMIP5 data locations indicated here are actually already 
declared in standard CliMAF API setup (by ``import site_settings`` and ``import standard_projects``)
"""
