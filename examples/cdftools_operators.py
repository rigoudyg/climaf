...
#    * ccdfvar : compute the spatial variance, 2D or 3D (output: excluded mean value, profile and profile of variance)
...
#
# - ccdfmxlheatc (computed the heat content in the mixed layer)
#
# - cdfstd =>
#    * ccdfstd : compute the standard deviation of given variables
#    * ccdfstdmoy : compute the mean value of the field, in addition to the standard deviation
#
...
# Define dataset with temperature ("thetao" in .nc <=> "votemper" for cdftools),
#
#mld ("omlmax" in .nc <=> "somxlt02" for cdftools)
#
ds1=ds(experiment="PRE6CPLCr2alb", variable="so", period="199807", realm="O")      #<=> d2
ds2=ds(experiment="PRE6CPLCr2alb", variable="thetao", period="199807", realm="O")  #<=> d3 & d4
ds3=ds(experiment="PRE6CPLCr2alb", variable="omlmax", period="199807", realm="O")  #<=> d5
ds4=ds(experiment="PRE6CPLCr2alb", variable="uo", period="199807", realm="O")      #<=> d1
ds5=ds(experiment="PRE6CPLCr2alb", variable="vo", period="199807", realm="O")
