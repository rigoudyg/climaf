...
# dimension : case where (t,y,x) are not degenerated
# -----------------------------------------------------------
# tas(time, lat, lon)
...
# this dimension : we will have a cross-section or a profile depending on time and level selection
# -----------------------------------------------------------
# ta(time, plev, lat, lon)
...
select_cross1 = plot(ta_zonal_mean, ta_zonal_mean2, title='Selecting index 10 for time', y="index", time=3000.)
cshow(select_cross1)
