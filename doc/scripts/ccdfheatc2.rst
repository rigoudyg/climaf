ccdfheatc2 : computes the heat content in the specified area (mono-variable input file)
----------------------------------------------------------------------------------------
...
**Climaf call example**:: 
  ...
  >>> my_cdfheatc=ccdfheatc2(dso,dtho,imin=100,imax=102,jmin=117,jmax=118,kmin=1,kmax=2,opt='-full')
